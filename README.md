12. 在 frontend-learning 仓库的 README 文件里实现如附件 readme.jpg 所示的效果，并在 frontend-learning 仓库的 issues 版块创建如附件 issues.jpg #示的 issues ，然后将 README 中的读书笔记目录链接到对应的 issues 。完成以上步骤之后，将该仓库的链接粘贴在本题的答案区域。
# 前端学习笔记<h1>
